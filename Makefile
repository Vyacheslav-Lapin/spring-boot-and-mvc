...
build:
	./mvnw verify
	chmod +x ./target/spring-boot-and-mvc-0.0.1-SNAPSHOT.jar

run:
	./mvnw spring-boot:run -Dspring.profiles.active=local
	#	./target/spring-boot-and-mvc-0.0.1-SNAPSHOT.jar
	#	java -jar --enable-preview ./target/spring-boot-and-mvc-0.0.1-SNAPSHOT.jar
...
git-fork-init: init
	git remote add upstream git://github.com/Vyacheslav-Lapin/spring-boot-and-mvc.git
	git fetch upstream
